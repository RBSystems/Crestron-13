...
namespace UserModule_KEYPRO255
{
    public class UserModuleClass_KEYPRO255 : SplusObject
    {
...
public UserModuleClass_KEYPRO255 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
