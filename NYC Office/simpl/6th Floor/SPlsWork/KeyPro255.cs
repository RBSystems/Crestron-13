...
namespace CrestronModule_KEYPRO255
{
    public class CrestronModuleClass_KEYPRO255 : SplusObject
    {
...
public CrestronModuleClass_KEYPRO255 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
