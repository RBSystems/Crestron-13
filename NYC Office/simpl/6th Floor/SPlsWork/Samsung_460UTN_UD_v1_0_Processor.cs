...
namespace UserModule_SAMSUNG_460UTN_UD_V1_0_PROCESSOR
{
    public class UserModuleClass_SAMSUNG_460UTN_UD_V1_0_PROCESSOR : SplusObject
    {
    ...
    public UserModuleClass_SAMSUNG_460UTN_UD_V1_0_PROCESSOR ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
